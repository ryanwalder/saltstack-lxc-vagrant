...
master_box      = settings['master_box']      || default_box
master_box_url  = settings['master_box_url']  || false
network         = settings['network']         || '10.0.3'
bridge          = settings['brigde']          || 'lxcbr0'
master_grains   = master['grains']            || {}
master_folders  = master['folders']           || [{"from" => "salt/states", "to"  => "/srv/salt"}, {"from" => "salt/pillar", "to" => "/srv/pillar"}]
